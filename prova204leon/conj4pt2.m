...
x1 = input("Digite um valor para x1, maior que 0.5 e menor que 3.5: ");
while x1 <= 0.5 || x1 >= 3.5
  x1 = input("Digite um valor para x1, maior que 0.5 e menor que 3.5: ");
endwhile
while x2 <= 0.5 || x2 >= 3.5
x2 = input("Digite um valor para x2, maior que 0.5 e menor que 3.5: ");
endwhile
y1 = 1/x1;
y2 = 1/x2;
...
figure(2, 'Name', '4.2 - Cálculo integral')
clf;
